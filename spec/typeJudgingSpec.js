const isArray = require('../src/isArray.js')
const isBoolean = require('../src/isBoolean.js')
const isDate = require('../src/isDate.js')
const isFinite = require('../src/isFinite.js')
const isNaN = require('../src/isNaN.js')
const isNull = require('../src/isNull.js')
const isNumber = require('../src/isNumber.js')
const isString = require('../src/isString.js')
const isUndefined = require('../src/isUndefined.js')
const isFunction = require('../src/isFunction.js')
const isRegExp = require('../src/isRegExp.js')
const isError = require('../src/isError.js')
